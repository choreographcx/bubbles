...
"Live mode Stripe keys are not configured. Connect live mode in Forminator payment settings first." => array( null, __("Live mode Stripe keys are not configured. Connect live mode in Forminator payment settings first.", "forminator"), ), // src/utils.js:1713
"Test mode Stripe keys are not configured. Connect test mode in Forminator payment settings first." => array( null, __("Test mode Stripe keys are not configured. Connect test mode in Forminator payment settings first.", "forminator"), ), // src/utils.js:1718
"Please fix the error(s) in the PRODUCTS/PLANS tab." => array( null, __("Please fix the error(s) in the PRODUCTS/PLANS tab.", "forminator"), ), // src/utils.js:1735
"Please fix the error(s) in the SETTINGS tab." => array( null, __("Please fix the error(s) in the SETTINGS tab.", "forminator"), ), // src/utils.js:1736
"Stripe Subscription Add-on is required." => array( null, __("Stripe Subscription Add-on is required.", "forminator"), ), // src/utils.js:1755
"Billing frequency should be greater than or equal to 1" => array( null, __("Billing frequency should be greater than or equal to 1", "forminator"), ), // src/utils.js:1790
"Use form settings (Above inputs)" => array( null, __("Use form settings (Above inputs)", "forminator"), ), // src/utils.js:1887
"Use form settings (Below inputs)" => array( null, __("Use form settings (Below inputs)", "forminator"), ), // src/utils.js:1887
...
"View results button" => array( null, __("View results button", "forminator"), ), // src/quiz/global/components/behaviour/questions/pagination-settings.js:85
"Customize the text that appears on the button that your users can click to view their quiz results." => array( null, __("Customize the text that appears on the button that your users can click to view their quiz results.", "forminator"), ), // src/quiz/global/components/behaviour/questions/pagination-settings.js:88
"View Results" => array( null, __("View Results", "forminator"), ), // src/quiz/global/components/behaviour/questions/pagination-settings.js:92
"Show page indicator" => array( null, __("Show page indicator", "forminator"), ), // src/quiz/global/components/behaviour/questions/pagination-settings.js:102
"Display current, and total page indicator" => array( null, __("Display current, and total page indicator", "forminator"), ), // src/quiz/global/components/behaviour/questions/pagination-settings.js:112
...
"You have unsaved changes" => array( null, __("You have unsaved changes", "forminator"), ), // src/form/components/pdf/slides/unsaved-changes.js:168
"Your form contains unsaved changes. Please save your form before proceeding." => array( null, __("Your form contains unsaved changes. Please save your form before proceeding.", "forminator"), ), // src/form/components/pdf/slides/unsaved-changes.js:172
"Save and Continue" => array( null, __("Save and Continue", "forminator"), ), // src/form/components/pdf/slides/unsaved-changes.js:189
...
"You need at least one payment plan!" => array( null, __("You need at least one payment plan!", "forminator"), ), // src/form/components/modals/settings.js:232
"Please select an email address for payment receipt." => array( null, __("Please select an email address for payment receipt.", "forminator"), ), // src/form/components/modals/settings.js:238
"Empty labels are not allowed for meta values!" => array( null, __("Empty labels are not allowed for meta values!", "forminator"), ), // src/form/components/modals/settings.js:249
"Billing Address field is required, and its Country subfield must be enabled." => array( null, __("Billing Address field is required, and its Country subfield must be enabled.", "forminator"), ), // src/form/components/modals/settings.js:267
"Please connect your PayPal account first!" => array( null, __("Please connect your PayPal account first!", "forminator"), ), // src/form/components/modals/settings.js:290
"Please enter PayPal payment amount!" => array( null, __("Please enter PayPal payment amount!", "forminator"), ), // src/form/components/modals/settings.js:295
"Please select PayPal payment variable field!" => array( null, __("Please select PayPal payment variable field!", "forminator"), ), // src/form/components/modals/settings.js:301
"Limit Min value should be less than Max value." => array( null, __("Limit Min value should be less than Max value.", "forminator"), ), // src/form/components/modals/settings.js:319
"Please enter API keys." => array( null, __("Please enter API keys.", "forminator"), ), // src/form/components/modals/settings.js:341
"Please select a valid end time limit." => array( null, __("Please select a valid end time limit.", "forminator"), ), // src/form/components/modals/settings.js:440
"Please fix the Default time error." => array( null, __("Please fix the Default time error.", "forminator"), ), // src/form/components/modals/settings.js:446
"Please fix the Start or End time." => array( null, __("Please fix the Start or End time.", "forminator"), ), // src/form/components/modals/settings.js:460
"Please fix the limit Start or End date." => array( null, __("Please fix the limit Start or End date.", "forminator"), ), // src/form/components/modals/settings.js:598
"Maximum Rating value should be less than 50." => array( null, __("Maximum Rating value should be less than 50.", "forminator"), ), // src/form/components/modals/settings.js:609
"Default Rating must be a whole number." => array( null, __("Default Rating must be a whole number.", "forminator"), ), // src/form/components/modals/settings.js:619
"Default Rating must be between 1 and Maximum Rating." => array( null, __("Default Rating must be between 1 and Maximum Rating.", "forminator"), ), // src/form/components/modals/settings.js:622
"Customize %s" => array( null, __("Customize %s", "forminator"), ), // src/form/components/modals/settings.js:700
"Customize %s Field" => array( null, __("Customize %s Field", "forminator"), ), // src/form/components/modals/settings.js:701
"Customize Page Visibility" => array( null, __("Customize Page Visibility", "forminator"), ), // src/form/components/modals/settings.js:705
"Geolocation" => array( null, __("Geolocation", "forminator"), ), // src/form/components/modals/settings.js:763
"Geolocation {{span}}Pro{{/span}}" => array( null, __("Geolocation {{span}}Pro{{/span}}", "forminator"), ), // src/form/components/modals/settings.js:765
"Products/Plans" => array( null, __("Products/Plans", "forminator"), ), // src/form/components/modals/settings.js:792
"Repeater" => array( null, __("Repeater", "forminator"), ), // src/form/components/modals/settings.js:812
"Limits" => array( null, __("Limits", "forminator"), ), // src/form/components/modals/settings.js:826
"Customize" => array( null, __("Customize", "forminator"), ), // src/form/components/modals/settings.js:878
...
"Delete Field Group" => array( null, __("Delete Field Group", "forminator"), ), // src/form/components/modals/delete.js:186
"Delete Field" => array( null, __("Delete Field", "forminator"), ), // src/form/components/modals/delete.js:186
"Are you sure you want to delete this group and all the fields it contains?" => array( null, __("Are you sure you want to delete this group and all the fields it contains?", "forminator"), ), // src/form/components/modals/delete.js:188
"Deleting this field {%(name)s} will also remove associated values from existing submissions." => array( null, __("Deleting this field {%(name)s} will also remove associated values from existing submissions.", "forminator"), ), // src/form/components/modals/delete.js:190
"Note that this field is mapped in {{link}}Default Meta Keys{{/link}}. If deleted, you will need to remap meta keys {{link}}here{{/link}}." => array( null, __("Note that this field is mapped in {{link}}Default Meta Keys{{/link}}. If deleted, you will need to remap meta keys {{link}}here{{/link}}.", "forminator"), ), // src/form/components/modals/delete.js:226
"Edit Field" => array( null, __("Edit Field", "forminator"), ), // src/form/components/modals/delete.js:288
"Please remove the references to this field from the following form fields first." => array( null, __("Please remove the references to this field from the following form fields first.", "forminator"), ), // src/form/components/modals/delete.js:316
...
"Credit / Debit Card" => array( null, __("Credit / Debit Card", "forminator"), ), // src/form/components/fields/stripe.js:164
"Language" => array( null, __("Language", "forminator"), ), // src/form/components/fields/stripe.js:188
"Choose your preferred language for the Stripe field. This will affect the placeholders language, and the card validation errors returned by the Stripe." => array( null, __("Choose your preferred language for the Stripe field. This will affect the placeholders language, and the card validation errors returned by the Stripe.", "forminator"), ), // src/form/components/fields/stripe.js:190
"Auto" => array( null, __("Auto", "forminator"), ), // src/form/components/fields/stripe.js:195
"English (en)" => array( null, __("English (en)", "forminator"), ), // src/form/components/fields/stripe.js:196
"Simplified Chinese (zh)" => array( null, __("Simplified Chinese (zh)", "forminator"), ), // src/form/components/fields/stripe.js:197
"Danish (da)" => array( null, __("Danish (da)", "forminator"), ), // src/form/components/fields/stripe.js:198
"Dutch (nl)" => array( null, __("Dutch (nl)", "forminator"), ), // src/form/components/fields/stripe.js:199
"Finnish (fi)" => array( null, __("Finnish (fi)", "forminator"), ), // src/form/components/fields/stripe.js:200
"French (fr)" => array( null, __("French (fr)", "forminator"), ), // src/form/components/fields/stripe.js:201
"German (de)" => array( null, __("German (de)", "forminator"), ), // src/form/components/fields/stripe.js:202
"Italian (it)" => array( null, __("Italian (it)", "forminator"), ), // src/form/components/fields/stripe.js:203
"Japanese (ja)" => array( null, __("Japanese (ja)", "forminator"), ), // src/form/components/fields/stripe.js:204
"Norwegian (no)" => array( null, __("Norwegian (no)", "forminator"), ), // src/form/components/fields/stripe.js:205
"Spanish (es)" => array( null, __("Spanish (es)", "forminator"), ), // src/form/components/fields/stripe.js:206
"Swedish (sv)" => array( null, __("Swedish (sv)", "forminator"), ), // src/form/components/fields/stripe.js:207
"Card icon" => array( null, __("Card icon", "forminator"), ), // src/form/components/fields/stripe.js:218
"Choose whether you want to show the card icon on the Stripe field." => array( null, __("Choose whether you want to show the card icon on the Stripe field.", "forminator"), ), // src/form/components/fields/stripe.js:220
"Postal code" => array( null, __("Postal code", "forminator"), ), // src/form/components/fields/stripe.js:236
"Choose whether you want to collect the postal code on the Stripe field." => array( null, __("Choose whether you want to collect the postal code on the Stripe field.", "forminator"), ), // src/form/components/fields/stripe.js:238
"Prefill (optional)" => array( null, __("Prefill (optional)", "forminator"), ), // src/form/components/fields/stripe.js:257
"Select field" => array( null, __("Select field", "forminator"), ), // src/form/components/fields/stripe.js:266
"If you are already collecting ZIP code on your form, you can pre-fill it on the Stripe field." => array( null, __("If you are already collecting ZIP code on your form, you can pre-fill it on the Stripe field.", "forminator"), ), // src/form/components/fields/stripe.js:280
"Payment Mode" => array( null, __("Payment Mode", "forminator"), ), // src/form/components/fields/stripe.js:305
"We recommend using Test mode to ensure the payments are working as expected and when you are ready to start collecting live payments, switch to Live payments mode. " => array( null, __("We recommend using Test mode to ensure the payments are working as expected and when you are ready to start collecting live payments, switch to Live payments mode. ", "forminator"), ), // src/form/components/fields/stripe.js:313
"Test" => array( null, __("Test", "forminator"), ), // src/form/components/fields/stripe.js:326
"{{link}}Connect your Stripe account{{/link}} and then come back to configure this field." => array( null, __("{{link}}Connect your Stripe account{{/link}} and then come back to configure this field.", "forminator"), ), // src/form/components/fields/stripe.js:345
"Charge currency" => array( null, __("Charge currency", "forminator"), ), // src/form/components/fields/stripe.js:362
"Choose the currency your users will be charged in." => array( null, __("Choose the currency your users will be charged in.", "forminator"), ), // src/form/components/fields/stripe.js:365
"Payment Plan" => array( null, __("Payment Plan", "forminator"), ), // src/form/components/fields/stripe.js:380
"Payment plans let you set up options for accepting payments on your site. You can add multiple plans and conditionally process them based on your form data." => array( null, __("Payment plans let you set up options for accepting payments on your site. You can add multiple plans and conditionally process them based on your form data.", "forminator"), ), // src/form/components/fields/stripe.js:388
"Note: You'll need to configure conditions on each plan to let Forminator know when to process each of the payment plans below." => array( null, __("Note: You'll need to configure conditions on each plan to let Forminator know when to process each of the payment plans below.", "forminator"), ), // src/form/components/fields/stripe.js:410
"There is an error in one or more of your payment plans. Please review the error and try again." => array( null, __("There is an error in one or more of your payment plans. Please review the error and try again.", "forminator"), ), // src/form/components/fields/stripe.js:437
"Payment Receipt" => array( null, __("Payment Receipt", "forminator"), ), // src/form/components/fields/stripe.js:466
"Choose whether you want Stripe to email a receipt to your customers on successful payment. Note that Stripe sends the email receipt only for live payments. {{link}}Customize email template{{/link}}." => array( null, __("Choose whether you want Stripe to email a receipt to your customers on successful payment. Note that Stripe sends the email receipt only for live payments. {{link}}Customize email template{{/link}}.", "forminator"), ), // src/form/components/fields/stripe.js:474
"Email address" => array( null, __("Email address", "forminator"), ), // src/form/components/fields/stripe.js:502
"E.g. john@doe.com" => array( null, __("E.g. john@doe.com", "forminator"), ), // src/form/components/fields/stripe.js:504
"Select an email field" => array( null, __("Select an email field", "forminator"), ), // src/form/components/fields/stripe.js:506
"Payment Details (optional)" => array( null, __("Payment Details (optional)", "forminator"), ), // src/form/components/fields/stripe.js:532
"You can add a statement decipher and a description to help you and your customers recognise the transactions made on this form." => array( null, __("You can add a statement decipher and a description to help you and your customers recognise the transactions made on this form.", "forminator"), ), // src/form/components/fields/stripe.js:540
"Statement decipher" => array( null, __("Statement decipher", "forminator"), ), // src/form/components/fields/stripe.js:549
"E.g. Company Name" => array( null, __("E.g. Company Name", "forminator"), ), // src/form/components/fields/stripe.js:552
"This is the business name your customers will see on their card statement." => array( null, __("This is the business name your customers will see on their card statement.", "forminator"), ), // src/form/components/fields/stripe.js:556
"Up to 22 characters only" => array( null, __("Up to 22 characters only", "forminator"), ), // src/form/components/fields/stripe.js:560
"Enter your payment description here" => array( null, __("Enter your payment description here", "forminator"), ), // src/form/components/fields/stripe.js:568
"This appears on your Stripe account and on the payment receipt sent to your customers." => array( null, __("This appears on your Stripe account and on the payment receipt sent to your customers.", "forminator"), ), // src/form/components/fields/stripe.js:571
"Payment description" => array( null, __("Payment description", "forminator"), ), // src/form/components/fields/stripe.js:574
"Card Validation" => array( null, __("Card Validation", "forminator"), ), // src/form/components/fields/stripe.js:593
"Note: Stripe field automatically validates the card as the user fills the card details regardless of the validation behavior set on the Behaviours tab." => array( null, __("Note: Stripe field automatically validates the card as the user fills the card details regardless of the validation behavior set on the Behaviours tab.", "forminator"), ), // src/form/components/fields/stripe.js:611
"Billing Details" => array( null, __("Billing Details", "forminator"), ), // src/form/components/fields/stripe.js:628
"If you are collecting billing details on your forms, you can send that data to Stripe. The billing details will appear on your Stripe dashboard for each payment." => array( null, __("If you are collecting billing details on your forms, you can send that data to Stripe. The billing details will appear on your Stripe dashboard for each payment.", "forminator"), ), // src/form/components/fields/stripe.js:636
"Customer name (optional)" => array( null, __("Customer name (optional)", "forminator"), ), // src/form/components/fields/stripe.js:659
"Select a name field" => array( null, __("Select a name field", "forminator"), ), // src/form/components/fields/stripe.js:661
"Customer email address (optional)" => array( null, __("Customer email address (optional)", "forminator"), ), // src/form/components/fields/stripe.js:676
"Billing address (optional)" => array( null, __("Billing address (optional)", "forminator"), ), // src/form/components/fields/stripe.js:693
"Select an address field" => array( null, __("Select an address field", "forminator"), ), // src/form/components/fields/stripe.js:695
"Meta Data" => array( null, __("Meta Data", "forminator"), ), // src/form/components/fields/stripe.js:720
"You can send custom meta data to Stripe. This would appear under the MetaData section of every payment. A maximum of 20 meta keys can be sent. The key name must be 20 characters or less, and the mapped data will be truncated to 500 characters as Stripe's requirements." => array( null, __("You can send custom meta data to Stripe. This would appear under the MetaData section of every payment. A maximum of 20 meta keys can be sent. The key name must be 20 characters or less, and the mapped data will be truncated to 500 characters as Stripe's requirements.", "forminator"), ), // src/form/components/fields/stripe.js:728
"MetaData" => array( null, __("MetaData", "forminator"), ), // src/form/components/fields/stripe.js:770
"Stripe automatically adds classes to the container DOM element based on the field state. However, you can customize them here. {{link}}Read more{{/link}}" => array( null, __("Stripe automatically adds classes to the container DOM element based on the field state. However, you can customize them here. {{link}}Read more{{/link}}", "forminator"), ), // src/form/components/fields/stripe.js:791
"Base class" => array( null, __("Base class", "forminator"), ), // src/form/components/fields/stripe.js:806
"Complete" => array( null, __("Complete", "forminator"), ), // src/form/components/fields/stripe.js:814
"Empty" => array( null, __("Empty", "forminator"), ), // src/form/components/fields/stripe.js:822
"Focused" => array( null, __("Focused", "forminator"), ), // src/form/components/fields/stripe.js:830
"Invalid" => array( null, __("Invalid", "forminator"), ), // src/form/components/fields/stripe.js:838
"Autofilled (Chrome and Safari only)" => array( null, __("Autofilled (Chrome and Safari only)", "forminator"), ), // src/form/components/fields/stripe.js:846
"Add your products, services and plans below. You can add multiple products and conditionally process each one based on your form data." => array( null, __("Add your products, services and plans below. You can add multiple products and conditionally process each one based on your form data.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:449
"Note: You'll need to configure conditions on each product to let Forminator know when to process each of the products below." => array( null, __("Note: You'll need to configure conditions on each product to let Forminator know when to process each of the products below.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:470
"There is an error in one or more of your products. Please review the error and try again." => array( null, __("There is an error in one or more of your products. Please review the error and try again.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:497
"Checkout Experience" => array( null, __("Checkout Experience", "forminator"), ), // src/form/components/fields/stripe-ocs.js:527
"Configure customer information and checkout behavior for Stripe Checkout." => array( null, __("Configure customer information and checkout behavior for Stripe Checkout.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:535
"Enhanced Checkout" => array( null, __("Enhanced Checkout", "forminator"), ), // src/form/components/fields/stripe-ocs.js:550
"Standard Checkout" => array( null, __("Standard Checkout", "forminator"), ), // src/form/components/fields/stripe-ocs.js:559
"Customers pay using a compact payment field on your form. " => array( null, __("Customers pay using a compact payment field on your form. ", "forminator"), ), // src/form/components/fields/stripe-ocs.js:564
"Adaptive Pricing" => array( null, __("Adaptive Pricing", "forminator"), ), // src/form/components/fields/stripe-ocs.js:573
"Show prices in your customer's local currency during checkout. Please ensure Adaptive Pricing is enabled in your {{adaptivePricingLink}}Stripe Dashboard{{/adaptivePricingLink}}." => array( null, __("Show prices in your customer's local currency during checkout. Please ensure Adaptive Pricing is enabled in your {{adaptivePricingLink}}Stripe Dashboard{{/adaptivePricingLink}}.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:577
"Your charge currency must be one of your Stripe settlement currencies. If needed, add currencies in {{settlementCurrenciesLink}}Stripe payouts settings{{/settlementCurrenciesLink}} before using Adaptive Pricing." => array( null, __("Your charge currency must be one of your Stripe settlement currencies. If needed, add currencies in {{settlementCurrenciesLink}}Stripe payouts settings{{/settlementCurrenciesLink}} before using Adaptive Pricing.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:602
"Note: Adaptive Pricing is unavailable for forms that use dynamic pricing." => array( null, __("Note: Adaptive Pricing is unavailable for forms that use dynamic pricing.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:629
"Switch any variable plan amount or quantity back to Fixed to enable Adaptive Pricing." => array( null, __("Switch any variable plan amount or quantity back to Fixed to enable Adaptive Pricing.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:633
"Checkout email" => array( null, __("Checkout email", "forminator"), ), // src/form/components/fields/stripe-ocs.js:643
"Use a Forminator Email field to prefill the customer's email in Stripe Checkout. If disabled or left unmapped, Stripe will ask the customer to enter their email during checkout." => array( null, __("Use a Forminator Email field to prefill the customer's email in Stripe Checkout. If disabled or left unmapped, Stripe will ask the customer to enter their email during checkout.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:645
"Email field" => array( null, __("Email field", "forminator"), ), // src/form/components/fields/stripe-ocs.js:655
"Checkout phone (optional)" => array( null, __("Checkout phone (optional)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:672
"Use a Forminator Phone field to prefill the customer's phone number in Stripe Checkout.  If disabled or left unmapped, no phone number will be collected." => array( null, __("Use a Forminator Phone field to prefill the customer's phone number in Stripe Checkout.  If disabled or left unmapped, no phone number will be collected.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:674
"Phone field" => array( null, __("Phone field", "forminator"), ), // src/form/components/fields/stripe-ocs.js:684
"Payment Methods" => array( null, __("Payment Methods", "forminator"), ), // src/form/components/fields/stripe-ocs.js:705
"Choose how customers can pay. The default option allows card payments only. To allow other payment methods like Venmo, Google Pay, or AliPay, select the Dynamic Payment Methods option below." => array( null, __("Choose how customers can pay. The default option allows card payments only. To allow other payment methods like Venmo, Google Pay, or AliPay, select the Dynamic Payment Methods option below.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:713
"Dynamic Payment Methods" => array( null, __("Dynamic Payment Methods", "forminator"), ), // src/form/components/fields/stripe-ocs.js:730
"You’ve selected dynamic payment methods. Please configure accepted payment methods on your {{link}}Stripe Dashboard{{/link}}." => array( null, __("You’ve selected dynamic payment methods. Please configure accepted payment methods on your {{link}}Stripe Dashboard{{/link}}.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:738
"Note: Only payment methods with immediate confirmation are supported." => array( null, __("Note: Only payment methods with immediate confirmation are supported.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:763
"{{link}}Learn more{{/link}}." => array( null, __("{{link}}Learn more{{/link}}.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:765
"Cards Only" => array( null, __("Cards Only", "forminator"), ), // src/form/components/fields/stripe-ocs.js:787
"Use these below options to enable and configure additional options for your Stripe payment." => array( null, __("Use these below options to enable and configure additional options for your Stripe payment.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:866
"Send Payment Receipt" => array( null, __("Send Payment Receipt", "forminator"), ), // src/form/components/fields/stripe-ocs.js:874
"You can enable or disable Payment Receipt emails in your {{link}}Stripe Dashboard{{/link}}. Note that Stripe sends the email receipt only for live payments." => array( null, __("You can enable or disable Payment Receipt emails in your {{link}}Stripe Dashboard{{/link}}. Note that Stripe sends the email receipt only for live payments.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:908
"Choose whether you want Stripe to email a receipt to your customers on successful payment. Note that Stripe sends the email receipt only for live payments." => array( null, __("Choose whether you want Stripe to email a receipt to your customers on successful payment. Note that Stripe sends the email receipt only for live payments.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:915
"Enable Billing Details" => array( null, __("Enable Billing Details", "forminator"), ), // src/form/components/fields/stripe-ocs.js:921
"Customer phone number (optional)" => array( null, __("Customer phone number (optional)", "forminator"), ), // src/form/components/fields/stripe-ocs.js:971
"Select a phone field" => array( null, __("Select a phone field", "forminator"), ), // src/form/components/fields/stripe-ocs.js:973
"Payment Element Layout" => array( null, __("Payment Element Layout", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1085
"Choose the Payment Element’s layout that fits your checkout flow." => array( null, __("Choose the Payment Element’s layout that fits your checkout flow.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1093
"Tabs" => array( null, __("Tabs", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1107
"Accordion with radio buttons" => array( null, __("Accordion with radio buttons", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1116
"Accordion without radio buttons" => array( null, __("Accordion without radio buttons", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1125
"Select a theme from the Stripe Appearance API to control the style of all elements." => array( null, __("Select a theme from the Stripe Appearance API to control the style of all elements.", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1158
"Night" => array( null, __("Night", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1167
"Customize Appearance" => array( null, __("Customize Appearance", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1176
"Customize Colors" => array( null, __("Customize Colors", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1183
"Primary color" => array( null, __("Primary color", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1188
"Error" => array( null, __("Error", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1209
"Other options" => array( null, __("Other options", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1217
"Border radius" => array( null, __("Border radius", "forminator"), ), // src/form/components/fields/stripe-ocs.js:1250
